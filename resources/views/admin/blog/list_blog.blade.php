      ...
      <table class="table table-striped b-t b-light">
        ...
        <tbody id="myTable">
                ...
                <tr>
                    ...
                    <td>{{$blog->id}}</td>
                    <td><span class="text-ellipsis">{{$blog->name}}</span></td>
                    <td>
                       <img width="100x" height="100px" src="../img_blog/{{$blog->img}}"> 
                    </td>
                    ...
                    <form action="{{route('blog.destroy',['blog'=>$blog->id])}}" width="10px" method="post">
                        @csrf
                        @method('delete')
                        <td width="10px">
                            <button type="submit">
