    ...
    <ul class="nav pull-right top-menu">
        ...
        <li class="dropdown">
            ...
            <ul class="dropdown-menu extended logout">
                ...
                <li><a href="{{route('admin.user.logout')}}"><i class="fa fa-key"></i> Đăng xuất</a></li>
            </ul>
        </li>
            ...
            <ul class="sidebar-menu" id="nav-accordion">
                <li>
                 ...
                 <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a href="{{route('user.create')}}">Tạo tài khoản</a></li>
                        <li><a href="{{route('brand.index')}}">Danh sách tài khoản</a></li>
                    </ul>
                </li>
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a href="{{route('bill.create')}}">Thêm hóa đơn</a></li>
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a href="{{route('order.create')}}">Thêm hóa đơn</a></li>
                        <li><a href="{{route('order.index')}}">Đơn hàng chờ xác nhận</a></li>
                        <li><a href="{{route('admin.order.sale')}}">Đơn hàng đã bán</a></li>
                    </ul>
                </li>
                 <li class="sub-menu">
                    <a href="javascript:;">
                    ...
                    <ul class="sub">
                        <li><a href="{{route('provider.create')}}">Thêm nhà cung cấp</a></li>
                        <li><a href="{{route('provider.index')}}">Danh sách nhà cung cấp</a></li>
                    </ul>
                </li>
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a href="{{route('admin.report.index')}}">Sản phẩm đã nhập</a></li>
                        <li><a href="vector_map.html">Sản phẩm đã bán</a></li>
                    </ul>
                </li>
                <li class="sub-menu">
                    <a href="javascript:;">
